...
**优先级**: P1  
**创建时间**: 2026-05-28  
**状态**: **开发交付定稿 v6.5.2**（对齐 PRD v1.0.16 · 与 [`UI/index.html`](./UI/index.html) 对齐）  
...
- **微信咨询弹窗**（点击卡片打开；6 路径共用）：
  ...
  - 中部：大尺寸二维码（统一素材 `wechat-consult-qr.png`）  
  - 底部提示 mono：**长按识别二维码**  
  - 点击遮罩或关闭按钮收起弹窗  
...
**产品与文档**
- [ ] 本文版本为 **v6.5.2**（对齐 v1.0.16），与 `UI/index.html` 及 `UI/assets/` 齐全  
...
| `homepage-playlist-cover.png` 等 | 视频/路径媒体占位 |
