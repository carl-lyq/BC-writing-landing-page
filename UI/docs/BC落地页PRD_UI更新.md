...
**优先级**: P1  
**创建时间**: 2026-05-28  
**状态**: **正式交付稿 v1.0.32**（与 [`UI/index.html`](../index.html) 对齐；开发冻结版见 [`BC落地页PRD_6.5.md`](../../BC落地页PRD_6.5.md)）  
...
| 出站转化 | 本页 CTA 可跳转主站产品页（T-002）；**躺着学 Logo** 回流主站首页 `https://igopx.cn/` |
...
- **导航品牌布局（已定）**：
  - **左侧**：躺着学 Logo **89×34**（Mobile **73×28**）；点击跳转主站首页 **`https://igopx.cn/`**（已定）
  - **右侧**：「登录/注册」按钮 + **BC备考平台**标识（**高度与躺着学 Logo 一致**：Desktop **34px**、Mobile **28px**；宽度等比自适应）；登录在 BC Logo **左侧**
  - **中间**：4 个锚点链接  
  - 桌面导航左右内边距 **32px**  
- Logo 点击：**躺着学 Logo** → [`https://igopx.cn/`](https://igopx.cn/)（已定）；BC 备考平台标识为展示用，**不**单独跳转  
