...
**优先级**: P1  
**创建时间**: 2026-05-28  
**状态**: **正式交付稿 v1.0.16**（与 [`UI/index.html`](../index.html) 对齐；开发冻结版见 [`BC落地页PRD_6.5.md`](../../BC落地页PRD_6.5.md)）  
...
**每条路径内容要素**：
- **媒体图**（16:10）：每条路径 **1 张**专属插图/产品截图；Demo 共用占位 `homepage-banner-790x494.png`；正式素材见 **T-016**  
- 序号 + kicker（mono 小标题）  
- 主标题（serif 大标题）  
- 正文描述（1 段）  
...
| 6 路径共用 1 张媒体占位图 | 每条路径 1 张 16:10 专属图 + 正式微信 QR | **T-016** |
