...
**优先级**: P1  
**创建时间**: 2026-05-28  
**状态**: **正式交付稿 v1.0.40**（与 [`UI/index.html`](../index.html) 对齐；开发冻结版见 [`BC落地页PRD_6.5.md`](../../BC落地页PRD_6.5.md)）  
...
5. 交付 HTML **保留**左侧「原型标注」控制条（可开关蓝/橙水滴）与右下角 Tweaks；**仅供开发/测试对照 PRD**，生产构建须剔除（见 §2.3）
