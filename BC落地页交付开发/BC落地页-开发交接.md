...
> **读者**：前端、后端、测试、数据  
> **版本**：开发交付定稿 **v6.5.2**（对齐 PRD v1.0.16 · 2026-05-28）  
...
| `UI/assets/` | 静态图（Nav Logo、Hero Banner、页脚、学员头像、微信 QR 等） |
...
| **T-016** | 6 条路径媒体图 + 微信咨询二维码 | 设计/运营 | 路径区视觉 / 私域转化 |

路径 CTA URL（01/03/04/05/06）与路径 02 文案（T-014）**已定**，见 PRD §2.2 功能 5。

---

## 8. 交叉校验结论（v6.5.1 交付审计）
